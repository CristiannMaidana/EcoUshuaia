              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PerfilOptionSettings(
                      nameUser: nombreCompleto,
                      user: usuario,
                    ),
                    SizedBox(height: 20),
                    ...
                    CustomCardOptionSettings(
                      ...
                      subtitulo:
                          'Avisos generales, novedades y alertas importantes.',
                    ...
                    CustomCardOptionSettings(
                      titulo: 'Recordatorios de calendario',
                      subtitulo:
                          'Eventos, anuncios, feriados y cambios de recorrido.',
                    ...
                    CustomCardOptionSettings(
                      titulo: 'Alertas por zona',
                      subtitulo:
                          'Mantenimiento, incidentes y cambios cercanos a tu ubicación.',
                    ...
                    CustomCardOptionSettings(
                      titulo: 'Radio de búsqueda por defecto',
                      subtitulo:
                          'Sugerencias automáticas de contenedores cercanos.',
                    ...
                    CustomCardOptionSettings(
                      titulo: 'Compartir datos para mejoras',
                    ...
                    CustomCardOptionSettings(
                      titulo: 'Borrar búsquedas y recientes',
                      subtitulo:
                          'Elimina direcciones, zonas y elementos vistos.',
                    ...
                    CustomCardOptionSettings(
                      ...
                      color: Colors.redAccent.withValues(alpha: 0.2),
                      actionSetting: () async {
                        await context.read<AuthUsuarioRepository>().logout();
